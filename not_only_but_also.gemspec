...
Gem::Specification.new do |s|
  ...
  s.files = ["MIT-LICENSE", "README.rdoc", "Rakefile", "lib/not_only_but_also.rb", "spec/rails_root", "spec/rails_root/app", "spec/rails_root/app/models", "spec/rails_root/app/models/post.rb", "spec/rails_root/app/models/post", "spec/rails_root/app/models/post/stuff.rb", "spec/rails_root/app/models/post/validations.rb", "spec/not_only_but_also_spec.rb", "spec/spec_helper.rb", "generators/not_only_but_also", "generators/not_only_but_also/templates", "generators/not_only_but_also/templates/context.erb", "generators/not_only_but_also/not_only_but_also_generator.rb"]
