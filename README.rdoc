...
This is where allowing for multiple files to define a class can help and is what NotOnlyButAlso allows. It defines a
convention to help with organise multiple files as well as avoiding the need for repititive when using modules as
